...
./compute-histogram 100 700 1300 < delta.txt > histo.txt

rm -f ./himage.png

./display-histogram.sh histo.txt "timer 1kHz running on CPU #$4 with scheduler: $2 , priority $myprio,  $5 disturber(s)" himage.png &
