...
// these values are specific to the MCP3004: 
	outbuf[0] = 0x01; // bit start is set,
	outbuf[1] = 0x8f; //mode single-ended, channel 0
	
// any value will work for the next byte since the value sent to the slave when reading from the slave does not matter
