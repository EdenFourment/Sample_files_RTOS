...
//
//  B. Stefanelli / Revised: 27 oct 2016
...
gpio_direction(23, INPUT);
gpio_direction(24, OUTPUT);
...
// toggle speed test
//GPIO_SET = 0x01000000; // for direct access to pin 24
//GPIO_CLR = 0x01000000;

//gpio_set(24);	// access through routine
//gpio_clr(24);
...
// pull-up pull-down test: gpio23 toggles between 0 and 1 

/*
gpio_pud(23,PULL_UP);
usleep(500);
gpio_pud(23,PULL_DOWN);
usleep(500);
*/
